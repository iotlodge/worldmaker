/**
 * transform--2-aggregator — Microservice Handler
 * Service ID: 85197ff4-006e-d6e3-6fa1-7735b572f3d0
 * Generated by WorldMaker Code Generator
 */
package com.worldmaker.transform..2.aggregator;
...
public class Transform2AggregatorHandler {

    private static final Logger logger = Logger.getLogger("transform--2-aggregator");

    // Metadata for static analysis / AI discovery
    public static final Map<String, String> METADATA = Map.of(
        "microservice", "transform--2-aggregator",
    ...
    public Map<String, Object> healthCheck() {
        ...
        resp.put("service", "transform--2-aggregator");
    ...
    public Map<String, Object> handleEvent(Map<String, Object> event) {
        ...
        logger.info("Processing action=" + action + " for transform--2-aggregator");
    ...
    private Map<String, Object> process(String action, Map<String, Object> data) {
        ...
        result.put("processed_by", "transform--2-aggregator");
