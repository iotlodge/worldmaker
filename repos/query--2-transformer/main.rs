// query--2-transformer — Microservice Handler
...
pub fn metadata() -> HashMap<&'static str, &'static str> {
    ...
    m.insert("microservice", "query--2-transformer");
...
pub fn health_check() -> HashMap<String, String> {
    ...
    resp.insert("service".into(), "query--2-transformer".into());
...
pub fn handle_event(action: &str, data: &HashMap<String, String>) -> HashMap<String, String> {
    println!("Processing action={} for query--2-transformer", action);

    let mut result = HashMap::new();
    result.insert("processed_by".into(), "query--2-transformer".into());
